...
public class StringManipulations01 {
	 ...
	 * 7)equals()  8)equalIgnoreCase() 9)indexOf()  10)length() 11)lastIndex()
	 * 
	 * 
	 */
    ...
    //startswith()  can be used with ONLY STRING. We can NOT use it with char
   ...
   //13 endswith() is used for to check if this String ends with the specific suffix
        //endswith()  can be used with ONLY STRING. We can NOT use it with char
   ...
   // But there are some differences : 1) In replaceAll() you can NOT use chars 
