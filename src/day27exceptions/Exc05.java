...
public class Exc05 {
	 ...
	 * 1)“throws” keyword is used for “checked exceptions”
	 	...
	 	5)After "throws " keyword, if you usew child and parent Exception Classes together , it works but not recommended
	 	because when you use parent it will cover the child
	 */

	public static void main(String[] args) throws  IOException ,FileNotFoundException{

       FileInputStream fis = new FileInputStream("src\\day26exceptions\\Exception");
