...
public class ForLoop01 {
	...
	/*
	 * Print all even integers from 100 to 95 on the console on the same line with 
	 * a space among them
	 */ 
	...
	/*
	 * Print all integers which are divisible by 5 from 100 to 23 in the same line with a space
	 */
	public static void printDivByFiveInt(){
